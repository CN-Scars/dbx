...
export default withEnglishFallback({
  ...
  mongoScript: {
    confirmTitle: "Ejecutar JavaScript de MongoDB",
    confirmMessage: "Este script puede ejecutar varias operaciones de MongoDB y modificar datos. Revisa el script completo antes de continuar.",
    confirmAction: "Ejecutar script",
    typeColumn: "Salida",
    valueColumn: "Valor",
    textOutput: "Texto",
    jsonOutput: "JSON",
    ...
    summary: "Resumen",
    summaryValue: "{succeeded} de {attempted} operaciones correctas · base de datos actual: {database}",
    outputTruncated: "La salida capturada alcanzó el límite de seguridad y se truncó.",
    errorUnsupportedApi: "La fachada JavaScript de DBX no admite esta API de MongoDB Shell.",
    errorTimeout: "La ejecución de JavaScript de MongoDB agotó el tiempo de espera.",
    errorCancelled: "La ejecución de JavaScript de MongoDB se canceló.",
    errorResourceLimit: "La ejecución de JavaScript de MongoDB alcanzó un límite de seguridad de recursos.",
    errorPartialCompletion: "Progreso de ejecución: se confirmó que {succeeded} de {attempted} operaciones intentadas se completaron. Las escrituras realizadas no se revirtieron.",
    errorUnknownOutcome: "Es posible que una operación de base de datos en curso se haya completado, pero se desconoce el resultado. Comprueba el estado de la base de datos antes de volver a intentarlo.",
    errorHost: "Falló una operación de MongoDB del script.",
    errorInvalidRequest: "La solicitud de JavaScript de MongoDB no es válida.",
    errorRuntime: "Falló la ejecución de JavaScript de MongoDB.",
    errorSafety: "Una política de seguridad bloqueó la ejecución de JavaScript de MongoDB.",
    errorSerialization: "No se pudo convertir de forma segura un valor de JavaScript de MongoDB.",
  },
  sqlParameters: {
