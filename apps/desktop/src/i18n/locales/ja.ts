...
export default withEnglishFallback({
  ...
  mongoScript: {
    confirmTitle: "MongoDB JavaScript を実行",
    confirmMessage: "このスクリプトは複数の MongoDB 操作を実行し、データを変更する可能性があります。続行する前にスクリプト全体を確認してください。",
    confirmAction: "スクリプトを実行",
    typeColumn: "出力",
    valueColumn: "値",
    textOutput: "テキスト",
    jsonOutput: "JSON",
    finalValue: "最終値",
    summary: "概要",
    summaryValue: "{attempted} 件中 {succeeded} 件の操作が成功 · 現在のデータベース: {database}",
    outputTruncated: "取得した出力が安全上限に達したため切り詰められました。",
    errorUnsupportedApi: "DBX の JavaScript ファサードはこの MongoDB Shell API をサポートしていません。",
    errorTimeout: "MongoDB JavaScript の実行がタイムアウトしました。",
    errorCancelled: "MongoDB JavaScript の実行がキャンセルされました。",
    errorResourceLimit: "MongoDB JavaScript の実行がリソース安全上限に達しました。",
    errorPartialCompletion: "実行状況: 試行した {attempted} 件中 {succeeded} 件の完了が確認されています。完了した書き込みはロールバックされていません。",
    errorUnknownOutcome: "実行中だったデータベース操作は完了している可能性がありますが、結果は不明です。再試行する前にデータベースの状態を確認してください。",
    errorHost: "スクリプト内の MongoDB 操作に失敗しました。",
    errorInvalidRequest: "MongoDB JavaScript リクエストが無効です。",
    errorRuntime: "MongoDB JavaScript の実行に失敗しました。",
    errorSafety: "安全ポリシーにより MongoDB JavaScript の実行がブロックされました。",
    errorSerialization: "MongoDB JavaScript の値を安全に変換できませんでした。",
  },
  sqlParameters: {
    title: "SQLパラメーター",
