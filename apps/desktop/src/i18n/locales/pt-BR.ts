...
export default withEnglishFallback({
  ...
  mongoScript: {
    confirmTitle: "Executar JavaScript do MongoDB",
    confirmMessage: "Este script pode executar várias operações do MongoDB e modificar dados. Revise o script inteiro antes de continuar.",
    confirmAction: "Executar script",
    typeColumn: "Saída",
    valueColumn: "Valor",
    textOutput: "Texto",
    jsonOutput: "JSON",
    ...
    summary: "Resumo",
    summaryValue: "{succeeded} de {attempted} operações concluídas · banco atual: {database}",
    outputTruncated: "A saída capturada atingiu o limite de segurança e foi truncada.",
    errorUnsupportedApi: "A fachada JavaScript do DBX não oferece suporte a esta API do MongoDB Shell.",
    errorTimeout: "A execução do JavaScript do MongoDB atingiu o tempo limite.",
    errorCancelled: "A execução do JavaScript do MongoDB foi cancelada.",
    errorResourceLimit: "A execução do JavaScript do MongoDB atingiu um limite de segurança de recursos.",
    errorPartialCompletion: "Progresso da execução: {succeeded} de {attempted} operações tentadas têm conclusão confirmada. As gravações concluídas não foram revertidas.",
    errorUnknownOutcome: "Uma operação de banco de dados em andamento pode ter sido concluída, mas o resultado é desconhecido. Verifique o estado do banco de dados antes de tentar novamente.",
    errorHost: "Uma operação do MongoDB no script falhou.",
    errorInvalidRequest: "A solicitação de JavaScript do MongoDB é inválida.",
    errorRuntime: "A execução do JavaScript do MongoDB falhou.",
    errorSafety: "Uma política de segurança bloqueou a execução do JavaScript do MongoDB.",
    errorSerialization: "Não foi possível converter com segurança um valor JavaScript do MongoDB.",
  },
  sqlParameters: {
