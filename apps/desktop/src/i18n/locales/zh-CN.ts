...
export default withEnglishFallback({
  ...
  mongoScript: {
    confirmTitle: "执行 MongoDB JavaScript",
    confirmMessage: "此脚本可以执行多个 MongoDB 操作，并可能修改数据。请检查完整脚本后再继续。",
    confirmAction: "执行脚本",
    typeColumn: "输出",
    valueColumn: "值",
    textOutput: "文本",
    ...
    finalValue: "最终值",
    summary: "摘要",
    summaryValue: "已成功执行 {succeeded}/{attempted} 个操作 · 当前数据库：{database}",
    outputTruncated: "捕获的输出已达到安全上限，部分内容已截断。",
    errorUnsupportedApi: "DBX 的 JavaScript 外观层暂不支持此 MongoDB Shell API。",
    errorTimeout: "MongoDB JavaScript 执行超时。",
    errorCancelled: "MongoDB JavaScript 执行已取消。",
    errorResourceLimit: "MongoDB JavaScript 执行已达到资源安全上限。",
    errorPartialCompletion: "执行进度：尝试执行的 {attempted} 个操作中，有 {succeeded} 个已确认完成；已完成的写入不会自动回滚。",
    errorUnknownOutcome: "中断时仍有一个数据库操作正在执行，其结果未知且可能已经完成。重试前请先核对数据库状态。",
    errorHost: "脚本中的 MongoDB 操作执行失败。",
    errorInvalidRequest: "MongoDB JavaScript 请求无效。",
    errorRuntime: "MongoDB JavaScript 执行失败。",
    errorSafety: "MongoDB JavaScript 执行被安全策略阻止。",
    errorSerialization: "MongoDB JavaScript 值无法安全转换。",
  },
  production: {
    title: "生产环境",
    connection: "生产连接",
