...
export default withEnglishFallback({
  ...
  mongoScript: {
    confirmTitle: "執行 MongoDB JavaScript",
    confirmMessage: "此指令碼可以執行多個 MongoDB 操作，並可能修改資料。請檢查完整指令碼後再繼續。",
    confirmAction: "執行指令碼",
    typeColumn: "輸出",
    valueColumn: "值",
    textOutput: "文字",
    ...
    finalValue: "最終值",
    summary: "摘要",
    summaryValue: "已成功執行 {succeeded}/{attempted} 個操作 · 目前資料庫：{database}",
    outputTruncated: "擷取的輸出已達安全上限，部分內容已截斷。",
    errorUnsupportedApi: "DBX 的 JavaScript 外觀層暫不支援此 MongoDB Shell API。",
    errorTimeout: "MongoDB JavaScript 執行逾時。",
    errorCancelled: "MongoDB JavaScript 執行已取消。",
    errorResourceLimit: "MongoDB JavaScript 執行已達資源安全上限。",
    errorPartialCompletion: "執行進度：嘗試執行的 {attempted} 個操作中，有 {succeeded} 個已確認完成；已完成的寫入不會自動回復。",
    errorUnknownOutcome: "中斷時仍有一個資料庫操作正在執行，其結果未知且可能已經完成。重試前請先核對資料庫狀態。",
    errorHost: "指令碼中的 MongoDB 操作執行失敗。",
    errorInvalidRequest: "MongoDB JavaScript 請求無效。",
    errorRuntime: "MongoDB JavaScript 執行失敗。",
    errorSafety: "MongoDB JavaScript 執行遭安全性原則阻擋。",
    errorSerialization: "MongoDB JavaScript 值無法安全轉換。",
  },
  sqlParameters: {
    title: "SQL 參數",
